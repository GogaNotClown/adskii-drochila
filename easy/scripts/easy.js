...
const results = [
	new Result("Не грусти)", 0, 'img/0.jpg'),
	new Result("Уже лучше, молодец)))", 2, 'img/2.jpg'),
	new Result("Держи немного соку)))", 4, 'img/4.png'),
	new Result("Иди возьми шоколадку)))", 6, 'img/6.jpg'),
  	new Result("Иди возьми пирожок с творогом на столе)))", 8, 'img/8.png'),
  	new Result("Я позвоню твоей маме и скажу, что ты умничка))))", 10, 'img/10.jpg'),
]
